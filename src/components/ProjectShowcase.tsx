...
export default function ProjectShowcase({ user }: ProjectShowcaseProps) {
          ...
          return (
            <Star
              ...
              className={`h-4 w-4 ${interactive ? "cursor-pointer hover:scale-115 transition-transform" : ""} ${
                filled ? "fill-orange-400 text-orange-400" : "text-gray-300 dark:text-slate-700"
              }`}
            />
          );
        })}
  ...
  return (
    <div className="dashboard-shell px-6 py-6 font-sans md:px-8">
      {/* HEADER SECTION - REPRODUCING LEAPSTART HIGH END EXPERIENTIAL BRANDING */}
      <div className="mb-8 border-b border-gray-100 dark:border-slate-800/60 pb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <div className="flex items-center gap-2 text-[10px] tracking-widest font-mono font-extrabold uppercase text-[#10B981] mb-1.5 bg-[#10B981]/5 px-2.5 py-1 rounded-full max-w-fit">
            ...
            <span>STUDENT EXPERIENTIAL WORK DEMONSTRATION</span>
          </div>
          <h1 className="font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-white md:text-4xl">
            Leap<span className="text-orange-500">Start</span> Showcase & Feed
          </h1>
        ...
        {user.role === "student" && (
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-zinc-950 dark:bg-zinc-100 dark:text-zinc-950 px-5 py-3 font-semibold text-white  cursor-pointer   transition-all"
          >
      ...
      <AnimatePresence>
        {isPostingFormOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="mb-8 rounded-xl border border-orange-500/20 bg-orange-50/10 p-6 dark:border-orange-500/10 dark:bg-slate-900/40  relative"
          >
            <button
              ...
              <div className="space-y-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-xs text-gray-900 outline-none focus:border-orange-500 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100"
                  />
                </div>
              ...
              <div className="space-y-3 flex flex-col justify-between">
                <div className="space-y-1 flex-1 flex flex-col">
                  ...
                  <textarea
                    ...
                    className="w-full flex-1 rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-xs text-gray-900 outline-none focus:border-orange-500 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 resize-none font-sans"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full rounded-lg bg-zinc-950 dark:bg-zinc-100 dark:text-zinc-950 py-3 font-semibold text-white hover:bg-zinc-800 dark:hover:bg-white  transition-all text-xs cursor-pointer"
                >
      ...
      {/* SEARCH AND FEED COMPONENT AREA */}
      <div className="mb-6 flex flex-col sm:flex-row items-center gap-3 bg-white dark:bg-[#0B0F17] p-3 rounded-xl border border-gray-200 dark:border-slate-800 ">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full rounded-xl bg-gray-50/40 dark:bg-slate-950 py-2.5 pl-10 pr-4 text-xs text-gray-900 dark:text-white outline-none border border-transparent focus:border-orange-500/50"
          />
        </div>
              ...
              >
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 border-b border-gray-50 dark:border-slate-800/50 pb-5">
                    ...
                    <div className="flex items-start gap-3.5">
                      <img
                        ...
                        className="h-12 w-12 rounded-xl bg-orange-50 border border-orange-400/20 object-cover shrink-0"
                      />
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="rounded-full bg-orange-100/60 hover:bg-orange-100 px-2.5 py-0.5 text-[9px] font-extrabold uppercase text-orange-700 dark:bg-orange-950/20 dark:text-orange-400 border border-orange-500/5 mt-0.5">
                    ...
                    <div className="flex items-center gap-2 lg:self-start">
                      ...
                      {proj.liveUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-1.5 rounded-lg bg-orange-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-zinc-800 dark:hover:bg-white transition-colors cursor-pointer"
                        >
                ...
                <div className="bg-gray-50/70 p-6 border-t border-gray-100 dark:bg-slate-950/20 dark:border-slate-800">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="rounded bg-orange-100 text-orange-800 text-[10px] font-bold px-1.5 py-0.2 dark:bg-orange-950/40 dark:text-orange-300 ml-1">
                          ...
                          <div className="flex items-center gap-2.5">
                            {fb.authorPfp ? (
                              <img
                                ...
                                alt={fb.authorName}
                                referrerPolicy="no-referrer"
                                className="h-7 w-7 rounded-lg bg-orange-10
/10"
                              />
                            ) : (
                              <div className="h-7 w-7 rounded-lg bg-orange-100 text-orange-700 text-xs font-bold flex items-center justify-center">
                                {fb.authorName[0]}
                              </div>
                            )}
                            <div>
                        ...
                        <p className="text-xs text-slate-700 dark:text-slate-300 mt-3 pl-1 leading-relaxed border-l-2 border-orange-500/20">
                          {fb.comment}
                        </p>
                      </div>
                    ))}
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs text-gray-900 outline-none focus:border-orange-500 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200"
                          />
                        </div>
                        <div className="space-y-1">
                      ...
                      <div className="md:col-span-2 space-y-3 flex flex-col justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 rounded-xl border border-gray-200 bg-white px-3 py-2 text-xs text-gray-950 outline-none focus:border-orange-500 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 "
                          />
                          <button
                            onClick={() => submitFeedback(proj.id)}
                            className="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-600 text-white  hover:bg-zinc-800 dark:hover:bg-white  cursor-pointer transition-colors"
          ...
          {filteredProjects.length === 0 && (
            <div className="py-16 text-center border border-dashed border-gray-200 dark:border-slate-800 rounded-xl bg-white dark:bg-[#0B0F17]">
